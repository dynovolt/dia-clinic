            ...
            <ul className="space-y-3" role="list">
              ...
              <li className="flex items-start text-sm text-muted-foreground">
                ...
                <div className="space-y-1">
                  ...
                  <p className="text-xs">{businessConfig.workingHours.weekday}</p>
                  <p className="text-xs">{businessConfig.workingHours.weekend}</p>
                  <p className="text-xs text-destructive/80 font-medium">{businessConfig.workingHours.sunday}</p>
                </div>
              </li>
            </ul>
          </div>
